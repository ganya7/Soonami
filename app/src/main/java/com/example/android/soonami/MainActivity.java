...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2012-01-01&endtime=2012-12-01" +
                    "&minmagnitude=6";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
         ...
         * throws is checked exception not user defined but system one
         */
